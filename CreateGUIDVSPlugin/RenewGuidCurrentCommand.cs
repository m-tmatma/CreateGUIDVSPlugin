...
namespace CreateGUIDVSPlugin
{
    ...
    internal sealed class RenewGuidCurrentCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("fe96c49c-a20e-4361-9228-a22f8cf6880c");
        ...
        private RenewGuidCurrentCommand(Package package)
        {
            if (package == null)
            {
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            string title = "RenewGuidCurrentCommand";
